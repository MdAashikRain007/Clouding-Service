...
public class ClerkWebHookController {
    ...
    @PostMapping("/clerk")
    public ResponseEntity<?> handleClerkWebhook(@RequestHeader("svix-id") String svixId , @RequestHeader("svix-timestamp") String svixTimedtsmp, @RequestHeader("svix-signature") String svixSignature, @RequestBody String payload){
        try{
            boolean isValid = verifyWebhookSignature(svixId,svixTimedtsmp,svixSignature,payload);
            if(!isValid){
    ...
    private void handleUserCreated(JsonNode data) {
        ...
        String photoUrl =data.path("photo_url").asText("");
    ...
    private boolean verifyWebhookSignature(String svixId, String svixTimedtsmp, String svixSignature, String payload) {
        //validation webhooks
        return true;
    }
}
